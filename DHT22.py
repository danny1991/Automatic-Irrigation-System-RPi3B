...
if __name__ == "__main__":
	...
	s = DHT22.sensor(pi, 4, LED=16, power=1)
	...
	while True:
		...
		print("{} humidity:{:3.2f} temperature:{:3.2f}C staleness:{:3.2f} bad_checksum:{} short_message:{} missing_message:{} sensor_resets:{}".format(
